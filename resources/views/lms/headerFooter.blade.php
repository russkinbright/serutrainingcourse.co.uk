<div class="container-fluid p-5"
    ...
    <div class="container-fluid">
        <div class="bg-white/80 shadow-2xl rounded-3xl p-10 glassmorphic tilt slide-up border border-purple-200/30 backdrop-blur-lg">
            <h1 class="text-5xl font-extrabold text-center bg-purple-500 text-transparent bg-clip-text mb-10 drop-shadow-xl animate-gradient">
            ...
            <div x-show="formMessage"
                ...
                <i :class="formStatus === 'success' ? 'fas fa-check-circle text-purple-600 animate-bounce' : 'fas fa-exclamation-circle text-red-600 animate-pulse'" class="mr-3"></i>
                <span x-text="formMessage"></span>
            </div>

            <!-- Loading Indicator -->
            <div x-show="isLoading" class="mb-8 p-5 rounded-2xl flex items-center justify-center bg-purple-100/80 text-purple-900">
                <svg class="w-5 h-5 mr-2 animate-spin text-purple-600" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
