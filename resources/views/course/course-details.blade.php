...
@section('content')
    <style>
        ...
        .glassmorphic{background:rgba(255,255,255,.1);backdrop-filter:blur(12px);border:1px solid rgba(255,255,255,.3);box-shadow:0 8px 32px rgba(0,0,0,.1)}
        .card-hover{transition:transform .3s ease,box-shadow .3s ease}
        .card-hover:hover{transform:translateY(-10px) scale(1.02);box-shadow:0 12px 24px rgba(0,0,0,.2)}
        .btn-pulse{position:relative;overflow:hidden}
        .btn-pulse::after{content:'';position:absolute;top:50%;left:50%;width:0;height:0;background:rgba(255,255,255,.3);border-radius:50%;transform:translate(-50%,-50%);transition:width .5s ease,height .5s ease}
        ...
        .loading-container{display:flex;flex-direction:column;align-items:center;justify-content:center;min-height:300px;background:rgba(255,255,255,.1);backdrop-filter:blur(12px);border-radius:1rem;border:1px solid rgba(255,255,255,.3);box-shadow:0 8px 32px rgba(0,0,0,.1);padding:2rem}
            ...
            >
                ...
                <div class="mb-6" data-aos="fade-up">
                    <template x-for="message in messages" :key="message.id">
                        <div :class="message.type === 'success' ? 'bg-green-100 border-green-500 text-green-700' : 'bg-red-100 border-red-500 text-red-700'"
                            ...
                            <button @click="messages = messages.filter(m => m.id !== message.id)" class="text-xl font-bold text-gray-700 hover:text-gray-900">×</button>
                        </div>
                    </template>
                </div>

                <!-- Hero -->
                <div x-show="course" class="relative h-96 rounded-2xl overflow-hidden mb-8 group shadow-2xl" data-aos="fade-up">
                    ...
                    <div class="relative z-10 flex flex-col items-center justify-center h-full text-center px-6">
                        <div class="px-6 py-4 bg-black/30 rounded-lg shadow-lg">
                            <h1 class="text-4xl md:text-5xl font-extrabold text-white drop-shadow-xl leading-tight" x-text="course?.title"></h1>
                            <p class="mt-3 flex items-center justify-center text-lg md:text-xl font-medium text-orange-300 drop-shadow-md">
                ...
                <div x-show="course" class="flex flex-col md:flex-row md:items-start gap-8 mb-8">
                    ...
                    <div class="md:w-[32%] sticky-cta">
                        <div class="bg-white glassmorphic rounded-2xl p-6 card-hover" data-aos="fade-up" data-aos-delay="100">
                ...
                <div x-show="course" class="mb-8" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <div class="review-slider">
                        <div class="review-container">
                            <div class="review-card bg-white glassmorphic rounded-2xl p-6 card-hover" data-aos="fade-right">
                                <div class="flex items-center mb-2">
                                    <div class="star-rating flex">
                                        <i class="fas fa-star checked"></i><i class="fas fa-star checked"></i><i class="fas fa-star checked"></i><i class="fas fa-star checked"></i><i class="fas fa-star"></i>
                                    </div>
                                    <span class="ml-2 text-gray-600">4.0</span>
                                </div>
                                <p class="text-gray-700">"This course was a game-changer! The content was engaging and well-structured."</p>
                                <p class="mt-2 text-gray-500 font-semibold">— Sarah J.</p>
                            </div>

                            <div class="review-card bg-white glassmorphic rounded-2xl p-6 card-hover" data-aos="fade-right" data-aos-delay="100">
                                <div class="flex items-center mb-2">
                                    <div class="star-rating flex">
                            ...
                            <div class="review-card bg-white glassmorphic rounded-2xl p-6 card-hover" data-aos="fade-right" data-aos-delay="200">
                                <div class="flex items-center mb-2">
                                    <div class="star-rating flex">
                                        <i class="fas fa-star checked"></i><i class="fas fa-star checked"></i><i class="fas fa-star checked"></i><i class="fas fa-star checked"></i><i class="fas fa-star-half-alt checked"></i>
                                    </div>
