...
@section('content')
    <div x-data="{
        ...
        countries: [ /* … your long countries list … */ ],
        ...
        clearSearch() { this.countrySearch = '';
            this.billing.country = '';
            this.showCountryDropdown = true; },
    
        /* Auto-pay when user selects Other */
        async payWithOtherNow() {
            if (this.processing) return;
            // Require terms + minimal billing (same rules you already have)
            ...
            // Reuse submitPayment but with method pre-set to 'other'
            this.paymentMethod = 'other';
            await this.submitPayment(true); // true => silent success handling (no redirect required)
        },
        ...
        async submitPayment(silentOnOther = false) {
            ...
            try {
                ...
                // Other path: show success in-page
                localStorage.removeItem('cartItems');
                localStorage.removeItem('cartDiscount');
                this.addMessage('Purchase successfully completed!', 'success');
    
                // Optional: light redirect after short pause
                setTimeout(() => {
                    // go to a page you prefer (dashboard, courses, etc.)
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div>
                        ...
                        <div class="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl p-6 border border-purple-200 transform hover:-translate-y-2 transition-all duration-300"
                            ...
                            <div x-show="paymentMethod === 'other'" class="text-purple-600 flex items-center"
                                data-aos="fade-up" data-aos-delay="300">
                                <svg class="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 24 24">
                            ...
                            <div class="mt-4">
                                <label class="flex items-center">
                                    ...
                                    <span class="text-gray-600">
                                        I agree to the <a href="#" @click.prevent="showTermsModal = true"
                                            class="text-purple-600 underline hover:text-purple-800">terms</a> and
                                        <a href="#" @click.prevent="showPrivacyModal = true"
                                            class="text-purple-600 underline hover:text-purple-800">privacy policy</a>.
                                    </span>
                                </label>
                            </div>

                            <!-- Keep button for Card/PayPal, Other uses instant button above -->
