...
@section('content')
    <style>
        ...
        .glassmorphic{background:rgba(255,255,255,0.1);backdrop-filter:blur(12px);border:1px solid rgba(255,255,255,0.3);box-shadow:0 8px 32px rgba(0,0,0,0.1)}
        ...
        .cart-table th{background:linear-gradient(to right,#4f46e5,#7c3aed);color:#fff;font-weight:600}
        .cart-table td{background:#fff}
        .cart-table img{width:64px;height:64px;object-fit:cover;border-radius:8px;border:1px solid #fbcfe8}
        .cart-table input{width:80px;border:2px solid #f472b6;border-radius:8px;padding:.5rem;text-align:center}
        @media (max-width:767px){.cart-table{display:none}.cart-card{display:block}}
        @media (min-width:768px){.cart-card{display:none}}
    </style>
                        ...
                        <tbody>
                            <template x-for="(item, index) in cartItems" :key="item.unique_id">
                                <tr class="card-hover">
                                    ...
                                    <td>
                                        <input type="number"
                                               x-model.number="cartItems[index].quantity"
                                               min="1"
