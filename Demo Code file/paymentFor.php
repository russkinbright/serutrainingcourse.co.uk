...
@section('content')
    <div x-data="{
                ...
                init() {
                    ...
                    console.log('Order Summary Rendered', this.cartItems);
                ...
                async submitPayment() {
                    ...
                    try {
                        ...
                        if (result.success && result.redirect_url) {
                            window.location.href = result.redirect_url; // Redirect to PayPal
                        } else {
        ...
        <div class="mx-auto max-w-[1500px] relative z-10 px-4 py-8">
            ...
            <div class="text-4xl font-bold mb-5 text-orange-500">
                <h1>Check Out</h1>
            </div>
                            ...
                            <div class="space-y-4 grid grid-cols-2 gap-6 relative z-10">
                                ...
                                <div>
                                    <label class="block text-gray-700 font-medium">Country <span
                                            class="text-red-500">*</span></label>
                                    <input x-model="billing.country" type="text" placeholder="Country" required
                                        class="w-full border-2 border-purple-500 rounded-lg px-4 py-3 text-sm focus:ring-2 focus:ring-pink-300 transition">
                                </div>
                                <div>
                                ...
                                <div class="col-span-2">
                                    ...
                                    <textarea x-model="billing.message" placeholder="Message"
                                        class="w-full border-2 border-purple-500 rounded-lg px-4 py-3 text-sm focus:ring-2 focus:ring-pink-300 transition"></textarea>
                                </div>
                            </div>
                        </div>
                    ...
                    <div
                        ...
                        <div class="flex space-x-4 mb-4">
                            <button @click="paymentMethod = 'card'"
                                ...
                                class="px-6 py-3 rounded-xl transition-all duration-300 hover:bg-purple-200 flex items-center font-bold hover:cursor-pointer">
                ...
                <div class="space-y-4 grid grid-cols-2 gap-5">
                    ...
                    <div>
                        ...
                        <input x-model="billing.email" type="email"
                            class="w-full border border-purple-200 p-3 rounded-lg bg-gray-100 focus:outline-none">
                    </div>
                    <div>
                        <label class="block text-gray-700 font-medium">Phone</label>
                        <input x-model="billing.phone" type="tel"
                            class="w-full border border-purple-200 p-3 rounded-lg bg-white focus:outline-none">
                    </div>
                    <div>
